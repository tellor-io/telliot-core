...
from telliot_core.contract.listener import event_message_handler, AddressEventListener, listener_client
from telliot_core.directory.tellorx import tellor_directory

logger = logging.getLogger('__name__')


async def tellor_listener_client(ws_url: str, chain_id: int):
    ...
    listeners = [
        AddressEventListener(address=master_info.address, handler=event_message_handler),
        AddressEventListener(address=oracle_info.address, handler=event_message_handler)
    ]
