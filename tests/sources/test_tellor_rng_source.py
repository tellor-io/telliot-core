...
from telliot_core.sources import blockhash_aggregator
from telliot_core.sources.blockhash_aggregator import get_btc_hash
from telliot_core.sources.blockhash_aggregator import get_eth_hash
