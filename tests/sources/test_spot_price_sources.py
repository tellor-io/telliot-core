...
from telliot_core.sources.price.spot.coingecko import CoinGeckoSpotPriceService
from telliot_core.sources.price.spot.gemini import GeminiSpotPriceService
from telliot_core.sources.price.spot.nomics import NomicsSpotPriceService
from telliot_core.sources.price.spot.pancakeswap import (
    PancakeswapPriceService,
)
from telliot_core.sources.price.spot.uniswapV3 import UniswapV3PriceService
